...
```
There is a difference evident across the majority of locations.This differences can be seen at the crouch phase(time: 0.18 - 0.38), Ascent phase(time: 0.42 - 0.7), and Peak force(time: 0.84 - 0.92) .
